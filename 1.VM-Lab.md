...
---
### Step 2 - Create SSH Keys (Local)
Within local Linux device
```bash
ssh-keygen -t rsa -b 2048 -f ~/.ssh/azure_key
```

---
### Step 3 - VM 1: Jumpbox (Public Access)
...
---
### Step 4 - VM 2: Web Server (Internal Only)
...
---
### Step 5 - SSH Configuration (Local)
